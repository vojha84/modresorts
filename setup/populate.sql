...
INSERT INTO MODRESORTSSTAFF (ID,NAME,AGE,BIO) VALUES (2,'Daniel',45,'Meet Daniel, a seasoned travel professional with over twenty years of industry expertise who is passionate about creating unforgettable experiences. At our company, he ensures that every hotel stay is packed with instant benefits and exceptional service. Daniel''s holistic approach to travel means he excels at uncovering hidden gems and tailoring personalized journeys to meet your unique needs. Outside of work, you’ll find him exploring new cultures, savoring local cuisines, and collecting stories from his global adventures.');
